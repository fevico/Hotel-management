    ...
    <!-- end page title -->
        ...
        <input type="hidden" value="{{ $room->id }}" name="id">
                <div class="mb-3">
                    ...
                    <input type="text" id="simpleinput" value="{{ $room->name }}" name="name" class="form-control">
                </div>
                <div class="mb-3">
                    ...
                    <option value="{{$item->id}}" {{ $item->id == $room->category_id ? 'selected' : ""}}>{{ $item->category_name }}</option>
                        @endforeach
                    </select>                
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="simpleinput" value="{{ $room->short_title }}" name="short_title" class="form-control">
                </div>
                
                <div class="mb-3">
                    <label for="simpleinput" class="form-label">Price</label>
                    <input type="text" id="simpleinput" value="{{ $room->price }}" name="price" class="form-control">
                </div>
                
                <div class="mb-3">
                    <label for="simpleinput" class="form-label">Quantity</label>
                    <input type="text" id="simpleinput" value="{{ $room->qty }}" name="qty" class="form-control">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <img id="showImage" src="{{ asset($room->image) }}" class="rounded-circle avatar-lg img-thumbnail"
                    alt="profile-image">      
                </div>
                     <!-- end tab-content -->
                </div>
