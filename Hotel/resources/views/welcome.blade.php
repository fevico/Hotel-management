 ...
 @include('frontend.body.header')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-4">
                    <div class="single_offers">
                        <div class="about_thumb">
                            <img src="{{ asset('frontend/asset/img/offers/1.png')}}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_offers">
                        <div class="about_thumb">
                            <img src="{{ asset('frontend/asset/img/offers/2.png')}}" alt="">
                        </div>
                        <h3>Up to 35% savings on Club <br>
                            rooms and Suites</h3>
                        <ul>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_offers">
                        <div class="about_thumb">
                            <img src="{{ asset('frontend/asset/img/offers/3.png')}}" alt="">
                        </div>
                        <h3>Up to 35% savings on Club <br>
                            rooms and Suites</h3>
                        <ul>
        ...
        <div class="rooms_here">
            <div class="single_rooms">
                <div class="room_thumb">
                    <img src="{{ asset('frontend/asset/img/rooms/1.png')}}" alt="">
            ...
            <div class="single_rooms">
                <div class="room_thumb">
                    <img src="{{ asset('frontend/asset/img/rooms/2.png')}}" alt="">
                    <div class="room_heading d-flex justify-content-between align-items-center">
                        <div class="room_heading_inner">
                            <span>From $250/night</span>
                            <h3>Deluxe Room</h3>
            ...
            <div class="single_rooms">
                <div class="room_thumb">
                    <img src="{{ asset('frontend/asset/img/rooms/3.png')}}" alt="">
                    <div class="room_heading d-flex justify-content-between align-items-center">
                        <div class="room_heading_inner">
                            <span>From $250/night</span>
            ...
            <div class="single_rooms">
                <div class="room_thumb">
                    <img src="{{ asset('frontend/asset/img/rooms/4.png')}}" alt="">
                    <div class="room_heading d-flex justify-content-between align-items-center">
                        <div class="room_heading_inner">
                            <span>From $250/night</span>
                            <h3>Couple Room</h3>
    ...
    <div class="instragram_area">
        <div class="single_instagram">
            <img src="{{ asset('frontend/asset/img/instragram/1.png')}}" alt="">
            <div class="ovrelay">
                <a href="#">
        ...
        <div class="single_instagram">
            <img src="{{ asset('frontend/asset/img/instragram/2.png')}}" alt="">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="{{ asset('frontend/asset/img/instragram/3.png')}}" alt="">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="{{ asset('frontend/asset/img/instragram/4.png')}}" alt="">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="{{ asset('frontend/asset/img/instragram/5.png')}}" alt="">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
